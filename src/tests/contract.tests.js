...
const { getFantasyGoldRPCAddress } = require('../../test/utils');
...
describe('Contract', () => {
  ...
  describe('constructor', () => {
    ...
    it('removes the hex prefix from the address', async () => {
      contract = new Contract(getFantasyGoldRPCAddress(), '0x1234567890', ContractMetadata.EventFactory.abi);
  ...
  describe('send()', () => {
    it('sends a transaction', async () => {
      const res = {
        ...
        sender: 'fKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy',
    ...
    it('returns the args object with the sent params', async () => {
      const res = {
        ...
        sender: 'fUNeKdqh269AwJWxDFnxUAqKSJ9deSUsgF',
