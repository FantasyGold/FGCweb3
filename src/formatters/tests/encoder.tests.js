...
describe('Encoder', () => {
  ...
  describe('addressToHex()', () => {
    it('should convert a fantasygold address', () => {
      assert.equal(
        Encoder.addressToHex('fKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy'),
        '00000000000000000000000017e7888aa7412a735f336d2f6d784caefabb6fa3',
      );
      assert.equal(
        Encoder.addressToHex('fKoxAUEQ1Nj6anwes6ZjRGQ7aqdiyUeat8'),
        '00000000000000000000000018b1a0dc71e4de23c20dc4163f9696d2d9d63868',
      );
      assert.equal(
        Encoder.addressToHex('fTumW1fRyySwmoPi12LpFyeRj8W6mzUQA3'),
  ...
  describe('validateMethodAndArgs()', () => {
    ...
    const args = ['fKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'Hello World', ['a', 'b', 'c'], 'c350', 'c738'];
    ...
    it('throws if methodArgs does not match args in ABI', () => {
      assert.throws(() => Encoder.validateMethodAndArgs(abi, 'createTopic', ['fKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'Hello World',
        ['a', 'b', 'c'], 'c350']), Error);
    });
  });
  ...
  describe('constructDataHex()', () => {
    ...
    it('constructs the datahex', () => {
      const args = ['fKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'Hello World', ['a', 'b', 'c'], '0xc350', '0xc738'];
    ...
    it('constructs the datahex for many different types', () => {
      ...
      const args = [
        ...
        true,
        ['49837717385', 1234567890, '0x87A23'],
        ['fKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'fKoxAUEQ1Nj6anwes6ZjRGQ7aqdiyUeat8'],
      ];
    ...
    it('converts address types', () => {
      ...
      const args = ['fKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy'];
    ...
    it('converts fixed array address types', () => {
      ...
      const args = [['fKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'fKoxAUEQ1Nj6anwes6ZjRGQ7aqdiyUeat8']];
      const dataHex = Encoder.constructData([methodObj], 'testMethod', args);
    ...
    it('throws if abi is undefined', () => {
      assert.throws(() => Encoder.constructData(undefined, 'test', ['fKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'Hello World',
        ['a', 'b', 'c'], 'c350', 'c738']), Error);
    });

    it('throws if methodName is undefined', () => {
      assert.throws(() => Encoder.constructData(abi, undefined, ['fKjn4fStBaAtwGiwueJf9qFxgpbAvf1xAy', 'Hello World',
        ['a', 'b', 'c'], 'c350', 'c738']), Error);
    });
  });
});
