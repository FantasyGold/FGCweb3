...
class FGCweb3 {
  /**
   * FGCweb3 constructor.
   * @param {string|Fweb3Provider} provider Either URL string to create HttpProvider or a FGCweb3 compatible provider.
   */
   ...
   * @param {string} urlString URL of the blockchain API. eg. http://local:local@127.0.0.1:58804
   ...
   * @param {number} blocks How many blocks are generated immediately.
   * @param {string} address The address to send the newly generated fantasygold to.
   * @param {number} maxTries How many iterations to try (default = 1000000).
   * @return {array} Hashes of blocks generated.
   */
  ...
  /** ******** RAW TRANSACTIONS ********* */
  /**
   * Get the hex address of a FantasyGold address.
   * @param {string} address FantasyGold address
  ...
  /**
   * Converts a hex address to fantasygold address.
   * @param {string} hexAddress FantasyGold address in hex format.
   * @return {Promise} FantasyGold address or Error.
   */
  ...
  /** ******** UTIL ********* */
  /**
   * Validates if a valid FantasyGold address.
   * @param {string} address FantasyGold address to validate.
   ...
   * @param {string} address The fantasygold address for the private key.
  ...
  /**
   * Encrypts the wallet for the first time. This will shut down the fantasygold server.
  ...
  /**
   * Gets the account name associated with the FantasyGold address.
   * @param {string} address The fantasygold address for account lookup.
  ...
  /**
   * Gets the FantasyGold address based on the account name.
  ...
  /**
   * Gets the FantasyGold address with the account name.
   * @param {string} acctName The account name ("" for default).
   * @return {Promise} FantasyGold address array or Error.
   */
  ...
  /**
   * Gets a new FantasyGold address for receiving payments.
   ...
   * @return {Promise} Array of addresses with FGC balances or Error.
   */
  ...
  /**
   * Lists unspent transaction outputs.
   * @param {string} address Address to send FGC to.
   * @param {number} amount Amount of FGC to send.
   ...
   * @param {string} senderAddress The FGC address that will be used to send money from.
   ...
   * @param {bumber} amount The transaction fee in FGC/kB.
